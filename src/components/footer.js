                ...
                <div style={{ height: "200px", marginTop: "20px", padding: "20px", background: "#294B29" }}>
                    ...
                    <div class="grid grid-rows-3 grid-flow-col gap-4">
                        <div class="row-span-3 flex justify-end flex-col items-end">
                            <div style={{ color: 'rgb(153, 232, 205)' }}>
                        ...
                        <div class="col-span-4 ">
                            <div className="flex justify-center gap-5">
                                <a href="https://github.com/nagendrayakkaladevara" target="_blank"><img src={GitHubImage} style={{ width: "40px" }} /></a>
                                <a href="https://www.linkedin.com/in/sai-nagendra-yakkaladevara-67317419a/" target="_blank"><img src={LinkedInImage} style={{ width: "40px" }} /></a>
                                <a href="https://twitter.com/nagendra_s_y" target="_blank"> <img src={TwitterImage} style={{ width: "40px" }} /></a>
                                <a href="https://www.instagram.com/nagendra_yakkaladevara/" target="_blank"><img src={InstagramImage} style={{ width: "40px" }} /></a>
                            </div>
                        </div>
